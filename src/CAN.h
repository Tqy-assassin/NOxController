...
#define BAUD_RATE_BRP				3		/*!< 1 Baud Rate Prescaler */
#define BAUD_RATE_SAMP				1		/*!< 0-One sample per bit, 1-three sample per bit. */
#define BAUD_RATE_TSEG1				TSEG_16  /*!< Time Segment 1*/
#define BAUD_RATE_TSEG2				TSEG_7  /*!< Time Segment 2*/
#define BAUD_RATE_CLOCK				24000000L/*!< clock source for MSCAN*/
...
#define RECEIVER_STATUS_RXBUS_OFF	3<<4	/*!<256≤transmit error counter1*/
...
#define TRANSMITTER_STATUS_TXBUS_OFF	3<<2		/*!<256≤transmit error counter1*/
...
typedef struct
{
	...
	uint8_t DSR[8];               /*!< data segment 数据段*/
...
//=======================================================================================
#define IDAR0		0x00000000
#define IDMR0		0xFFFFFFFF
#define IDAR1		0x00000000
#define IDMR1		0xFFFFFFFF
